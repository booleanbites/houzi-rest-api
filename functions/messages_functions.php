...
add_action('rest_api_init', function () {
    register_rest_route('houzez-mobile-api/v1', '/all_threads', array(
        'methods' => 'GET',
...
add_action('rest_api_init', function () {
    register_rest_route('houzez-mobile-api/v1', '/start_thread',
        array(
            'methods' => 'POST',
...
add_action('rest_api_init', function () {
    register_rest_route( 'houzez-mobile-api/v1', '/all_messages',
        array(
            'methods' => 'GET',
