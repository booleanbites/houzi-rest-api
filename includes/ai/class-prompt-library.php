		...
		switch ( $feature ) {
			case 'search':
				$prompt = "You are a real-estate search assistant for a property website. "
					...
					. "If the user message includes a CURRENT SEARCH STATE, that state IS the search being refined — base your "
					. "output on its filters and locations (not on earlier turns) and re-emit its locations unless the user changes them.\n"
