...
class Houzi_Rest_Api {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Houzi_Rest_Api_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'HOUZI_REST_API_VERSION' ) ) {
			$this->version = HOUZI_REST_API_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'houzi-rest-api';
	 ...
	 *
	 * - Houzi_Rest_Api_Loader. Orchestrates the hooks of the plugin.
	 * - Houzi_Rest_Api_i18n. Defines internationalization functionality.
	 * - Houzi_Rest_Api_Admin. Defines all hooks for the admin area.
	 * - Houzi_Rest_Api_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-houzi-rest-api-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-houzi-rest-api-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-houzi-rest-api-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-houzi-rest-api-public.php';

		$this->loader = new Houzi_Rest_Api_Loader();
	 ...
	 *
	 * Uses the Houzi_Rest_Api_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Houzi_Rest_Api_i18n();
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Houzi_Rest_Api_Public( $this->get_plugin_name(), $this->get_version() );
	...
	function houzi_rest_api_inc_files() {
		...
		require_once( HOUZI_REST_API_PLUGIN_PATH . 'functions/users_verification_functions.php');
		...
		require_once( HOUZI_REST_API_PLUGIN_PATH . 'functions/ai_functions.php');
		//require_once( HOUZI_REST_API_PLUGIN_PATH . 'functions/user_notifications.php');
	 ...
	 *
	 * @since     1.0.0
	 * @return    Houzi_Rest_Api_Loader    Orchestrates the hooks of the plugin.
	 */
